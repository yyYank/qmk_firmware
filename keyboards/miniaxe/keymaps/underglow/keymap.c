 ...
 * |   Z  |   X  |   C  |   V  |   B  |           |   N  |   M  |   ,  |   .  |   /  |
 * `-------------+------+------+------|           |------+------+------+------+------'
 *               | GUI  | LOWER|Ctrl/SPC|         |Ent/Sft| RAISE|Alt/BkSp |
 *               `--------------------'           `--------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
                    KC_LGUI, LOWER, MT(MOD_LCTL, KC_SPC),   MT(MOD_LSFT, KC_ENT), RAISE, MT(MOD_LALT, KC_BSPC)  \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_CAPS, KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,       KC_SCLN, KC_QUOT, KC_LT,   KC_LBRC, KC_RBRC, \
                    KC_LANG2, _______, _______,      _______,  _______, KC_LANG1\
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_TAB,  _______, _______, _______, _______,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ESC, \
