...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
        GRV,     Q,     W,     E,     R,     T,  LBRC,                              RBRC,     Y,     U,     I,     O,     P,  BSLS,\
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
        TAB,     A,     S,     D,     F,     G, LOWER,                              BSPC,     H,     J,     K,     L,  SCLN,  QUOT,\
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
       LSFT,     Z,     X,     C,     V,     B,                                               N,     M,  COMM,   DOT,  SLSH,  RSFT,\
  //|------+------+------+------+------+------+-----------------|     |------ ------------------+------+------+------+------+------|
      LCTL, LALT,                LGUI,  LGUI,    SPC,  ENT,   ENT,      SPC,  SPC,  ENT,  RGUI, DOWN,                   LEFT, RGHT \
  //`------+--------/            \-----+------+------+------+------'  `----+------+------+------+-----/              \------+------'
  ),

  [_LOWER] = LAYOUT_kc( \
  //,------------------------------------------------.                            ,------------------------------------------------.
      _____,    F1,    F2,    F3,    F4,    F5,   F6,                                 F7,    F8,   F10,   EQL,  JYEN,  LBRC,  RBRC,\
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
  ...
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
      LOWER, XXXXX,              _____, _____, _____, _____, _____,   _____, _____, _____, UP, _____,               XXXXX, RAISE \
  //`------+--------/            \-----+------+------+------+------'  `----+------+------+------+-----/              \------+------'
 ),
  ...
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
      _____, LSMOD,  LHUD,  LSAD,  LVAD, XXXXX, XXXXX,                              XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,\
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
      _____, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,                                            XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,\
  //|------+------+------+------+------+------+------|                            |------+------+------+------+------+------+------|
      LOWER, XXXXX,               _____, _____, _____, _____, _____,  _____, _____, _____, _____, _____,               XXXXX, RAISE \
